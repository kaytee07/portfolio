  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        group-hover/canvas-card:-translate-y-4  translate-x-[-50%] translate-y-[-50%]
        ...
        <p className="dark:text-white text-center text-xl opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200"
        style={{ color: "#e4ecff"}}>
            {description}
        </p>
      </div>
