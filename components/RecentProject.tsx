      ...
      justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {
          projects.map(({ id, title, des,img, iconLists,
            ...
            flex items-center justify-center sm:w-[570px] w-[80vw]">
              <PinContainer className="w-full" title={link} href={link}>
                <div className="relative flex items-center
                justify-center sm:w-[570px] w-[80vw] overflow-hidden
                h-[30vh] sm:h-[40vh] mb-10">
                  <div className="elative w-full h-full overflow-hidden
                  lg:rounded-3xl bg-[#13162d]">r
                ...
                mt-7 mb-3">
                  <div className="flex items-center">
                    {iconLists.map((icon, i) => (
                      <div key={i} className="border-white/[0.2] rounded-full bg-black
                      lg:w-10 lg:h-10 w-8 h-8 flex justify-center items-center"
                      style={{
                        transform: `translate(-${5 * i * 2})px`
                        }}>
